...
| Theme | `components/core/ui/theme/` — see [`MIGRATION.md`](components/core/ui/theme/MIGRATION.md) before touching any screen's colors |
...
- Migrate a screen's colors to `FlipperPalletV2` when you're already touching that screen for a UI change —
  never touch a screen only to swap its theme calls. Follow `components/core/ui/theme/MIGRATION.md`, don't
  re-derive the mapping. Never hand-edit anything under `.../theme/.../pallet/generated` — it's autogenerated.
